...
public class OwnerController {
    ...
    public void setAllowedFields(WebDataBinder dataBinder) {
        //we don't want the id to be bind automatically (primary key)
    ...
    //owner here in the parameter should be using @Valid
    @PostMapping("/new")
    ...
    //owner here in the parameter should be using @Valid
    //since we have the init binder, all the form variables except the id will be bind to Owner
